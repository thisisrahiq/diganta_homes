...
CORS_ALLOW_ALL_ORIGINS = True # Allow all origins for now to fix deployment issues
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Railway/Whitenoise best practice
